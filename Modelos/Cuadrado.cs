...
namespace Clase_16___Ejercicio.Modelos
{
    ...
    {
        public Cuadrado(float XpuntoA, float YpuntoA, float XpuntoB, float YpuntoB, float XpuntoC, float YpuntoC, float XpuntoD, float YpuntoD) : base(XpuntoA, YpuntoA, XpuntoB, YpuntoB, XpuntoC, YpuntoC, XpuntoD, YpuntoD)
        {
        ...
        {
            return Math.Pow(CalcularDistanciaDosPuntos(
                _coordenadasXPuntoA, _coordenadasYPuntoA,
                _coordenadasXPuntoB, _coordenadasYPuntoB),2);
        }
    }
}
